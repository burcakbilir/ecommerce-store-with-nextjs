        ...
        <section className="text-gray-700 body-font overflow-hidden bg-white dark:bg-slate-900">
         {loading ? <div>Loading...</div> : (
           ...
           <div className="lg:w-4/5 mx-auto flex flex-wrap">
             <Image src={product?.image}  alt="ecommerce" className="lg:w-1/2 w-full h-[600px] object-contain object-center rounded-md border border-gray-200 p-10 dark:border-gray-600 bg-white" width={300} height={300} priority/>
